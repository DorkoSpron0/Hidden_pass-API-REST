...
public class PasswordMapperFunction {

    public static final Function<PasswordModel, PasswordDBO> functionModelToDBO = (PasswordModel model) ->
            new PasswordDBO(
    ...
    public static final Function<PasswordDBO, PasswordModel> functionDBOTOModel = (PasswordDBO dbo) ->
            new PasswordModel(
                    dbo.getId_password(),
                    dbo.getName(),
                    dbo.getDescription(),
                    ...
                    dbo.getUrl(),
                    dbo.getDateTime(),
                    dbo.getId_folder() != null ? new FolderModel(
    ...
    public static final Function<PasswordDTO, PasswordModel> functionDTOToModel = (PasswordDTO dto) -> new PasswordModel(
            null,
            dto.getName(),
            dto.getDescription(),
            dto.getEmail_user(),
            ...
            dto.getUrl(),
            dto.getDateTime(),
            dto.getId_folder() != null ? new FolderModel(
